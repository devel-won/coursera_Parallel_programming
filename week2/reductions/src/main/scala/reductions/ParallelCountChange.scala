...
object ParallelCountChange {
  ...
  def parCountChange(money: Int, coins: List[Int], threshold: Threshold): Int = {
    money match {
      ...
      case m if threshold(m, coins) => countChange(money - coins.head, coins) + countChange(money, coins.tail)
      case _ => {
        val par = parallel(parCountChange(money - coins.head, coins, threshold),
